    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-6">
        ...
        <p className="mt-2 text-sm text-zinc-500">
          Use the sidebar to open Clients, Settings (admin), or Users (admin).
        </p>
      </div>
      {counts && (
        <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-6">
            ...
            {(["lead", "qualified", "closed", "active", "churned"] as const).map(
              (status) => (
                <Link
                  ...
                  className="rounded-lg border border-zinc-700 bg-zinc-800/50 px-4 py-2 text-sm hover:bg-zinc-800"
                >
